...
import type { UserApplicationDetails } from "@/app/(applications)/recruiter-applications/types";

interface RecruiterApplicationDetailsPageClientProps {
  jobId: string;
  application: UserApplicationDetails;
}

export default function RecruiterApplicationDetailsPageClient({
  jobId,
  application,
}: RecruiterApplicationDetailsPageClientProps) {
  const resumeLink =
      ...
      <div className="mx-auto max-w-5xl px-6 py-10 space-y-8">
        <header className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Review this candidate&apos;s interview scores, AI-generated feedback,
            and open their resume directly in your browser.
          </p>
        </header>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <ScoreItem label="Technical" value={application.technicalScore} />
                <ScoreItem
                  label="Communication"
